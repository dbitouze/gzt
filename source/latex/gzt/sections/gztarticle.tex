...
\refEnv{gzttable*} admettent en argument optionnel :
\begin{itemize}
...
\end{docKey}
\item la clé \refKey{copyright} suivante :\begin{docKey}{copyright}{=\meta{titulaire}}{pas de valeur par défaut, initialement
    vide}
...
\begin{docKey}{title}{=\meta{titre du listing}}{pas de valeur par défaut,
    initialement vide}
