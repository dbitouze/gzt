...
\item attaché à la version \format{pdf} du présent document et atteignable par
  simple clic sur l'icone ci-dessous.
\end{itemize}
%
\tcbinputlisting{codes,listing only,listing
  options={moretexcs={addbibresource}},title={\attachfiletextlink~\attachfile[icon=Paperclip]{\attachfilename}}}
